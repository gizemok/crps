...
class AcademicMasterScraper:
    ...
    def scrape_arxiv(self, query):
        ...
        try:
            req = urllib.request.Request(url, headers={'User-Agent': 'AcademicBot/1.0'})
            ...
            for entry in root.findall("{http://www.w3.org/2005/Atom}entry"):
                ...
                if pdf_url:
                    # PDF uzantisi ekle ki pypdf tanisin
        ...
        try:
            ...
            for paper in data.get('data', []):
                ...
                if oa and oa.get('url'):
                    ...
                    time.sleep(5) # IP Rate Limit onlemi
        except Exception as e:
    ...
    def run_all(self):
        print("=========================================================")
        print("    ULTIMATE ACADEMIC MASTER SCRAPER BASLATILDI")
